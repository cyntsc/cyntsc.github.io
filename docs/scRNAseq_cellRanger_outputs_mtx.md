...
En el análisis de **single-cell RNA-seq (scRNA-seq)**, los datos no se generan directamente como matrices listas para análisis. A partir de archivos sin procesar - raw data (**FASTQ**), herramientas como **:contentReference[oaicite:0]{index=0}** de **:contentReference[oaicite:1]{index=1}** realizan el procesamiento inicial: alineamiento, cuantificación y filtrado de células.
...
Esto es especialmente importante en contextos de formación:

- MTX permite ver cómo está construida la matriz  
- H5 permite ejecutar análisis de forma eficiente  
